      ...
      <div className="container-fluid px-3 px-md-4 py-3 py-md-4">
        ...
        <div className="card shadow-lg border-0 rounded-4 p-3 p-md-4">
          ...
          <div className="mb-3 mb-md-4">
            <h5 className="fw-semibold mb-3">BUSQUEDAS</h5>
              ...
              <table className="table table-hover table-sm align-middle custom-table">
                <thead className="table-dark">
                  <tr>
                    ...
                    <th className="text-nowrap">Fecha Entrada</th>
                    <th className="text-nowrap">Hora Entrada</th>
                    <th className="text-nowrap">Hora Salida</th>
                    <th className="text-nowrap">Duración (min)</th>
